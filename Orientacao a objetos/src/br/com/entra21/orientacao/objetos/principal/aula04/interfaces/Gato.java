...
public class Gato implements Individuo {
	...
	public void alimentar(String alimento) {
		System.out.println(this.nome + ": miau, posso não gostar disso, mas o meu dono " + this.dono.getNome()
				+ " só me dá " + alimento);
	...
	public void comunicar(String conteudo) {
		System.out.println(this.nome + " miau miau miaaau... traduzindo " + conteudo);
