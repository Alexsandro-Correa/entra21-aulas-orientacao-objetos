...
public class Velocista extends Atleta { // minha classe Velocista pegando atributos da minha super-Classe Atleta
	...
	@Override
	// Override protege em relação a alterações de sintaxe,
	// como visibilidade, tipo de retorno, nome do método e parâmetros.
	...
	public void comemorarVitoria() {
		...
		System.out.println(getName() + " ah estou cansado mas fui campeão.");
	}
